...
help =
  ...
  , ""
  , "   --encode-muclp       : encodes a spec to MuCLP used by 'muval'"
  , "   --encode-ltlmt       : encodes a spec as LTLMT formula used by 'Syntheos'"
  , "   --encode-sweap       : encodes a spec as specification used by 'Sweap'"
  , ""
