...
-- context of a single DOA. Two states of different DOAs can be equal in the program without
...
-- | These are the different acceptance conditions available for a DOA
data Acceptance
  = Safety (Set State)
